...
namespace Movies.Client.Services
{
    public class CRUDService : IIntegrationService
    {
        ...
        public async Task UpdateResource()
        {
            ...
            var updateMovie = JsonSerializer.Deserialize<Movie>(content);
        }
        ...
        private async Task PostResourceShortcut()
        {
            ...
            var response = await _httpClient.PostAsync(
                "api/movies", new StringContent(
                    JsonSerializer.Serialize(movieToCreate), Encoding.UTF8, "application/json"));
            response.EnsureSuccessStatusCode();
